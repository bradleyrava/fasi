...
#' Both the r-score+ and r-score can be implimented.
#'
...
#' @param rscore_plus Logical variable, T/F, that determines if the r-score or r-score plus is calculated.
#' @param r2_indicator Logical variable, T/F, that determines if the r1 or r2 score is calculated.
